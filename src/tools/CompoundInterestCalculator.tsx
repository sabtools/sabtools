  ...
  return (
    <div className="space-y-6">
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex gap-2 flex-wrap">
            {[{l:"Yearly",v:1},{l:"Half-Yearly",v:2},{l:"Quarterly",v:4},{l:"Monthly",v:12},{l:"Daily",v:365}].map((f) => (
      ...
      <div className="result-card grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 text-center shadow-sm"><div className="text-xs font-medium text-gray-500 mb-1">Total Interest</div><div className="text-2xl font-extrabold text-green-600">{fmt(result.interest)}</div></div>
