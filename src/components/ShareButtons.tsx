...
export default function ShareButtons({ title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <button onClick={shareWhatsApp} className="w-9 h-9 rounded-xl bg-green-50 hover:bg-green-100 flex items-center justify-center transition" title="Share on WhatsApp">
